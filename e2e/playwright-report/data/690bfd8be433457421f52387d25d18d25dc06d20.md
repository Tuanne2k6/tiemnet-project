...
- Name: full-flow.spec.js >> E2E - Luồng khách hàng (tài khoản do nhân viên/admin tạo sẵn) >> Khách hàng có thể tự đổi mật khẩu ở trang Tài khoản của tôi
- Location: tests\full-flow.spec.js:47:3

# Error details

```
Error: locator.fill: Error: strict mode violation: getByLabel('Mật khẩu mới') resolved to 2 elements:
    1) <input value="" required="" id="pw-new" type="password" class="form-control"/> aka getByRole('textbox', { name: 'Mật khẩu mới', exact: true })
    2) <input value="" required="" type="password" id="pw-confirm" class="form-control"/> aka getByRole('textbox', { name: 'Nhập lại mật khẩu mới' })

Call log:
  - waiting for getByLabel('Mật khẩu mới')
      ...
      - generic [ref=e32]:
        ...
        - generic [ref=e34]:
          - generic [ref=e35]:
            ...
            - textbox "Mật khẩu hiện tại" [active] [ref=e37]: Passw0rd123
          - generic [ref=e38]:
